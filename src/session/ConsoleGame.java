...
/**
 * This class is runnable in the console. With it, the game can be played
 * without a GUI, and is therefore ideal for testing purposes.
 * 
 * @author tthielen
 */
public class ConsoleGame {
	private static GameSession gs = new GameSession();
	...
	public static void main(String[] args) throws IOException {
		DataHandler.useDictionaryFile(new File("resources/Collins Scrabble Words (2019) with definitions.txt"));
	...
	/**
	 * Prints the board in its current state, as well as the count of tiles left in
	 * the bag.
	 * 
	 * @author tthielen
	 */
	...
	/**
	 * Requests input from the player. There are several commands available besides
	 * simply choosing a letter from the rack or pressing ENTER to submit the move
	 * (if possible). Returns true if only a letter was chosen.
	 * 
	 * @author tthielen
	 * @param canMakePlay
	 * @return tileChosen

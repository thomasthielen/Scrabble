...
public class OfflineScreenController {
	...
	/**
	 * This method serves as the Listener for "PLAY GAME"-Button It redirects the
	...
	/**
	 * This method serves as the Listener for "TRAINING MODE"-Button It redirects
	 * the user to the Lobby Screen
	 *
	 * @author jbleil
	 * @param event
	 * @throws Exception

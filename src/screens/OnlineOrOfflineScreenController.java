...
public class OnlineOrOfflineScreenController {
	...
	/**
	 * This method serves as the Listener for "ONLINE"-Button
     * It redirects the user to the Online Screen
	 * 
	 * @author jbleil
	 * @param event
	 * @throws Exception
    ...
    /**
     * This method serves as the Listener for "SINGLEPLAYER"-Button
     * It redirects the user to the Offline Screen
     * 
     * @author jbleil
     * @param event
     * @throws Exception

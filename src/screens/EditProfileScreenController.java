...
public class EditProfileScreenController {
	...
	/**
	 * This method serves as the Listener for "SUBMIT CHANGES"-Button TODO It allows
	 * the user to save the changes to the Profile and redirects him back to the
	...
	/**
	 * This method serves as the Listener for "DELETE PROFILE"-Button TODO It allows
	 * the user to delete the selected Profile and redirects him back to the
	 * Existing Profile Screen
	 *
	 * @author jbleil
	 * @param event

...
/**
 * This class provides the Controller for the Game Screen and handles all the
 * interaction with the Players during the game
 *
 * @author jbleil
 */
public class GameScreenController {
	...
	/**
	 * gameBoard represents the Container for the Game Board, the tiles and the (for
	 * the game flow necessary) buttons
	 */
	@FXML
	 ...
	 * Rack - fill the board with Rectangles -> opacity = 100 (see through) - fill
	 * gridPane with Rectangles
	 *
	 * @author jbleil
	 * @throws Exception
	 */
	...
	/**
	 * TODO - get the color, the letter and the number of the currently selected
	 * Tile - set the box of the
	 *
	 * @author jbleil
	 * @param event
	 * @throws Exception
	...
	/**
	 * TODO this methods serves as a Listener for the GridPane, which displays the
	 * the GameBoard If a Tile from the Rack is selected it is
	 *
	 * @author jbleil
	 * @param event
	 * @throws Exception
	...
	/**
	 * This method serves as the Listener for "Player Statistics"-Button If the
	 * Statistics are open it closes the and if they are closed it opens them
	 *
	 * @author jbleil
	 * @param event
	 * @throws Exception
	...
	/**
	 * This method serves as the Listener for "X"-Button from the
	 * playerStatisticsPane It closes the Player Statistics
	 *
	 * @author jbleil
	 * @param event
	 * @throws Exception
	...
	/**
	 * This method serves as the Listener for "CHAT"-Button If the Chat is open it
	 * closes it and if it's closed it opens them
	 *
	 * @author jbleil
	 * @param event
	 * @throws Exception
	...
	/**
	 * This method serves as the Listener for "X"-Button from the chatPane It closes
	 * the Chat
	 *
	 * @author jbleil
	 * @param event
	...
	/**
	 * This method serves as the Listener for "Leave Game"-Button It let's the user
	 * leave the game and redirects him to the StartScreen
	 *
	 * @author jbleil
	 * @param event
	 * @throws Exception
	...
	/**
	 * TODO This method serves as the Listener for "Send"-Button from the chatPane
	...
	/**
	 * TODO This method serves as the Listener for "BAG"-Button from the
	 * gameBoardPane It opens a popUp-Window in which the user can see all the
	 * remaining tiles
	 *
	 * @author jbleil
	 * @param event
	...
	/**
	 * TODO This method serves as the Listener for "Recall"-Button from the
	 * gameBoardPane It allows the user to call back the tiles he has laid on the
	 * gameBoard in the current move
	 *
	 * @author jbleil
	 * @param event
	 * @throws Exception
	...
	/**
	 * TODO This method serves as the Listener for "Submit"-Button from the
	 * gameBoardPane The Button gets enabled if the user lays a valid word on the
	 * gameBoard If the user presses the Button the layed word is submitted and it's
	...
	/**
	 * TODO This method serves as the Listener for "Swap"-Button from the
	 * gameBoardPane Opens a popUp-Window in which the user can swap one or more
	 * tiles out of his rack with new Tiles from the Bag
	 *
	 * @author jbleil
	 * @param event
	 * @throws Exception
	...
	/**
	 * TODO This method serves as the Listener for the Submit Button in the
	 * popUp-Window which opens when you click the "Swap"-Button from the
	 * gameBoardPane
	 *
	 * @author jbleil
	 * @param event

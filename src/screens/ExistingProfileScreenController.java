...
public class ExistingProfileScreenController {
	...
	/**
	 * This method serves as the Listener for "START GAME"-Button It redirects the
	 * user to the Online or Offline Screen
	 *
	 * @author jbleil
	 * @param event
	 * @throws Exception
	...
	/**
	 * This method serves as the Listener for "EDIT PROFILE"-Button It redirects the
	 * user to the Edit Profile Screen
	 *
	 * @author jbleil
	 * @param event
	 */

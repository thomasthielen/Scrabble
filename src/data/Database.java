...
class Database {
	...
	/**
	 * Gives back the ID, username and avatar of each player from the table PlayerInfo in PlayerDB.
	 * It returns a HashMap that uses the player's ID as the key and the player Data in a String Array as the value.
	 * Index 0 marks the username in the Array, while index 1 stands for the avatar.
	 * 
	 * @return playerInfo
	 *
	 * @author jluellig

...
/**
 * This class is in charge of everything related to the dictionary used in the
 * game for the user (not the AI). It stores words in the dictionary and
 * provides methods to search the dictionary or check if a word is a part of the
 * dictionary.
 *
 * @author jluellig
 */
class UserDictionary {
	...
	/**
	 * This method initializes the HashMaps for the dictionary with each letter
	 * combination.
	 *
	 * @author jluellig
	 */

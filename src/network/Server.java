...
/**
 * A Server instance is created that hosts the game and to which each client can
 * connect and communicate to
 *
 * @author tikrause
 */
public class Server {
	...
	/**
	 * Constructor: creates a new server that waits for connections at the given
	 * port
	 *
	 * @author tikrause
	 * @param port

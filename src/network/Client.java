...
/**
 * For each client that joins the game a Client instance is created which
 * connects to the server and can send or receive any messages or notifications
 *
 * @author tikrause
 */
public class Client {
	...
	/**
	 * connects the client instance to the server and opens a TCP connection that
	 * can be used to send or receive messages and to update the game status
	 *
	 * @author tikrause
	 * @throws InterruptedException
	 * @throws IOException
